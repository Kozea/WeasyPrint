...
@pytest.mark.parametrize(('source', 'messages'), [
    ...
    ('@import "relative-uri.css"', ['ERROR: Relative URI reference']),
    ('@import "invalid-protocol://absolute-URL"', ['ERROR: Failed to load stylesheet']),
    ('test', ['WARNING: Parse error']),
    ('@test', ['WARNING: Unknown empty rule']),
    ('@test {}', ['WARNING: Unknown rule']),
    ('@import::before "test.css"', ['WARNING: Invalid @import']),
    ('@page { @top-left super { content: "a" } }', ['WARNING: Invalid prelude']),
    ('@page { @unknown { content: "a" } }', ['WARNING: Unknown @page rule']),
    ('@page { @footnote::before { content: "a" } }', ['WARNING: Invalid prelude']),
])
