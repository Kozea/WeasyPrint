...
def test_path_wrong_point():
    assert_pixels('path_wrong_point', '''
        ____________
        GG__________
        GG__________
        GG__________
...
@assert_no_logs
def test_path_markers_l():
    assert_pixels('path_markers_l', '''
        _________zz_
        _RR_____zzRz
        _RRGGGGzzRzz
        _RRGGGzzRzz_
...
@assert_no_logs
def test_path_markers_hv():
    assert_pixels('path_markers_hv', '''
        _________zz_
        _RR_____zzRz
        _RRGGGGzzRzz
        _RRGGGzzRzz_
